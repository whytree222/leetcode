...
**2.我对于何时需要维护一个指针存在疑问**
<span style="color: red;">答：如果在操作后还需要用到链表则需要维护指针（如需要返回这个链表），如果不需要则随意。</span>
...
![本题代码的执行用时分布和消耗内存分布](https://img2024.cnblogs.com/blog/3760500/202605/3760500-20260525150456594-171214728.png)